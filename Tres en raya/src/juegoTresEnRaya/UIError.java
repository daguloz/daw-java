...
public class UIError extends JDialog {
	...
	public UIError() {
		...
		contentPanel.setLayout(null);
		{
			...
			txtrTresEnRaya.setBounds(33, 53, 167, 94);
			txtrTresEnRaya.setText("¡Las fichas no pueden ser iguales!");
			contentPanel.add(txtrTresEnRaya);
		}
		
		JLabel lblTresEnRaya = new JLabel("Error");
		lblTresEnRaya.setIcon(new ImageIcon(UIError.class.getResource("/com/sun/java/swing/plaf/windows/icons/Error.gif")));
